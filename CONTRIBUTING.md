...
6. **段落**：段间空一行。
7. **用字约定（简体优先原则）**：
   - **正文一律使用简体中文**；底本若为繁体，应转换为简体。
   - 转换后如有**无简体中文对应**的文字（如**通假字**、**异体字**、**避讳字**、**佛道音译专名**、**梵文巴利文译音**、**人名地名特定字**等），**保留原文字**并在注释中说明。
     常见例子：
     - 「罷」保留（古义罢/疲），不要改为「罢」
     - 「勗」保留（劝勉），不要改为「勖」
     - 「乾」在卦名「乾/坤」上保留（不要改为「干」）
     - 佛经音译「菩提」「般若」「伽蓝」「阿耨多罗三藐三菩提」等保留
     - 道经专名「鍊/煉/鍾」按底本保留
   - 生僻字、生僻人名、若可输入应保留原字形，不可输入时可在脚注说明。
   - 转换依据可参考 [《通用规范汉字表》](https://www.gov.cn/zwgk/2010-11-23/content_1753340.htm) 及《第一批异体字整理表》。
   - 若底本中确有简体版本（如《十三经注疏》清阮元刻本的现代简体整理本），应使用该简体本。
